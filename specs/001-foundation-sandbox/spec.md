...
2. **Given** civilian pedestrians are active, **When** they navigate the district, **Then** they remain on sidewalks and crosswalks except when valid crossing behavior says otherwise.
